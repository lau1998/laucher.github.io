import { g as getDefaultExportFromCjs, h, a as getCurrentInstance, e as effectScope, i as inject, o as onMounted, b as onUnmounted, s as shallowRef, r as ref, d as computed, f as onBeforeMount, w as watch, F as Fragment, j as isRef, k as createVNode, T as Text, l as defineComponent, E as ElConfigProvider, m as resolveComponent, n as openBlock, p as createBlock, q as withCtx, u as unref, t as reactive, v as nextTick, x as provide, y as watchEffect, z as markRaw, A as toRaw, B as isVue2, C as isReactive, D as toRef, G as set$2, H as del, I as toRefs, c as commonjsGlobal, J as commonjsRequire, K as ElMessage, L as ElLoading, M as createElementBlock, N as createBaseVNode, O as resolveDirective, P as createCommentVNode, Q as renderSlot, R as withDirectives, S as normalizeStyle, U as renderList, V as createTextVNode, W as toDisplayString$1, X as mergeProps, Y as createSlots, Z as normalizeProps, _ as guardReactiveProps, $ as createApp, a0 as ICONS, a1 as installer } from './element-plus.2c54c765.js';
import { m as mockJs } from './mockjs.5bb7b8f9.js';
...
const toDisplayString = (val) => {
    return val == null
        ? ''
        : isArray$3(val) || (isPlainObject$2(val) && val.toString === objectToString)
...
const generate = (ast, options = {} // eslint-disable-line
    ...
    const filename = isString$2(options.filename)
        ? options.filename
        : 'message.intl';
...
function getPluralIndex(options) {
    // prettier-ignore
    const index = isNumber$2(options.pluralIndex)
        ? options.pluralIndex
        : -1;
    // prettier-ignore
    return options.named && (isNumber$2(options.named.count) || isNumber$2(options.named.n))
        ? isNumber$2(options.named.count)
            ? options.named.count
            : isNumber$2(options.named.n)
                ? options.named.n
                : index
        : index;
}
...
function createMessageContext(options = {}) {
    ...
    const pluralRule = isObject$2(options.pluralRules) &&
        isString$2(locale) &&
        isFunction$2(options.pluralRules[locale])
        ? options.pluralRules[locale]
        : pluralDefault;
    const orgPluralRule = isObject$2(options.pluralRules) &&
        isString$2(locale) &&
        isFunction$2(options.pluralRules[locale])
        ? pluralDefault
        : undefined;
    ...
    function message(key) {
        // prettier-ignore
        const msg = isFunction$2(options.messages)
            ? options.messages(key)
            : isObject$2(options.messages)
                ? options.messages[key]
                : false;
        return !msg
            ? options.parent
    ...
    const _modifier = (name) => options.modifiers
        ...
        : DEFAULT_MODIFIER;
    const normalize = isPlainObject$2(options.processor) && isFunction$2(options.processor.normalize)
        ? options.processor.normalize
        : DEFAULT_NORMALIZE;
    const interpolate = isPlainObject$2(options.processor) &&
        isFunction$2(options.processor.interpolate)
        ? options.processor.interpolate
        : DEFAULT_INTERPOLATE;
    const type = isPlainObject$2(options.processor) && isString$2(options.processor.type)
    ...
    const linked = (key, ...args) => {
        ...
        if (type === 'vnode' && isArray$3(msg) && modifier) {
            msg = msg[0];
        }
...
function fallbackWithLocaleChain(ctx, fallback, start) {
    ...
    if (!chain) {
        ...
        const defaults = isArray$3(fallback) || !isPlainObject$2(fallback)
            ? fallback
            : fallback['default']
                ? fallback['default']
                : null;
...
function appendItemToChain(chain, target, blocks) {
    ...
    if (!chain.includes(target)) {
        ...
        if (target) {
            ...
            chain.push(locale);
            if ((isArray$3(blocks) || isPlainObject$2(blocks)) &&
    ...
    return {
        upper: (val, type) => {
            ...
            return type === 'text' && isString$2(val)
                ? val.toUpperCase()
                : type === 'vnode' && isObject$2(val) && '__v_isVNode' in val
...
function createCoreContext(options = {}) {
    ...
    const fallbackLocale = isArray$3(options.fallbackLocale) ||
    ...
    const postTranslation = isFunction$2(options.postTranslation)
    ...
    const messageCompiler = isFunction$2(options.messageCompiler)
        ? options.messageCompiler
        : _compiler;
    const messageResolver = isFunction$2(options.messageResolver)
        ? options.messageResolver
        : _resolver || resolveWithKeyValue;
    const localeFallbacker = isFunction$2(options.localeFallbacker)
        ? options.localeFallbacker
        : _fallbacker || fallbackWithSimple;
    const fallbackContext = isObject$2(options.fallbackContext)
        ? options.fallbackContext
        : undefined;
    const onWarn = isFunction$2(options.onWarn) ? options.onWarn : warn$2;
    // setup internal options
    const internalOptions = options;
    const __datetimeFormatters = isObject$2(internalOptions.__datetimeFormatters)
            ? internalOptions.__datetimeFormatters
            : new Map()
        ;
    const __numberFormatters = isObject$2(internalOptions.__numberFormatters)
...
function checkHtmlMessage(source, options) {
    ...
    if (warnHtmlMessage && RE_HTML_TAG.test(source)) {
        warn$2(format$1(WARN_MESSAGE, { source }));
    }
}
...
function translate(context, ...args) {
    ...
    // prettier-ignore
    const defaultMsgOrKey = isString$2(options.default) || isBoolean(options.default) // default by function option
    ...
    if (!resolvedMessage &&
        !(isString$2(format) || isMessageFunction(format))) {
        if (enableDefaultMsg) {
    ...
    if (isString$2(format) && context.messageCompiler == null) {
        warn$2(`The message format compilation is not supported in this build. ` +
...
function resolveMessageFormat(context, key, locale, fallbackLocale, fallbackWarn, missingWarn) {
    ...
    for (let i = 0; i < locales.length; i++) {
        ...
        if (isString$2(format) || isFunction$2(format))
            break;
...
function datetime(context, ...args) {
    ...
    if (!isPlainObject$2(format) || !isString$2(targetLocale)) {
        return unresolving ? NOT_REOSLVED : key;
    }
...
function createComposer(options = {}, VueI18nLegacy) {
    ...
    __root && _inheritLocale
        ...
        : isString$2(options.fallbackLocale) ||
            isArray$3(options.fallbackLocale) ||
            isPlainObject$2(options.fallbackLocale) ||
            options.fallbackLocale === false
            ? options.fallbackLocale
            : _locale.value);
    ...
    let _runtimeMissing = isFunction$2(options.missing)
        ? defineCoreMissingHandler(options.missing)
        : null;
    // postTranslation handler
    let _postTranslation = isFunction$2(options.postTranslation)
        ? options.postTranslation
        : null;
    // prettier-ignore
        ...
        if (isNumber$2(ret) && ret === NOT_REOSLVED) {
            ...
            if (__root &&
                ...
                if (_fallbackRoot &&
                    ...
                    warn$2(getWarnMessage(I18nWarnCodes.FALLBACK_TO_ROOT, {
                        key,
                        type: warnType
                    }));
                }
    ...
    function normalize(values) {
        return values.map(val => isString$2(val) || isNumber$2(val) || isBoolean(val)
    ...
    function transrateVNode(...args) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        root => root[TransrateVNodeSymbol](...args), key => [createTextNode(key)], val => isArray$3(val));
    }
    // numberParts, using for `i18n-n` component
    function numberParts(...args) {
        return wrapWithDeps(context => Reflect.apply(number, null, [context, ...args]), () => parseNumberArgs(...args), 'number format', 
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        root => root[NumberPartsSymbol](...args), () => [], val => isString$2(val) || isArray$3(val));
    }
    // datetimeParts, using for `i18n-d` component
    function datetimeParts(...args) {
        return wrapWithDeps(context => Reflect.apply(datetime, null, [context, ...args]), () => parseDateTimeArgs(...args), 'datetime format', 
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        root => root[DatetimePartsSymbol](...args), () => [], val => isString$2(val) || isArray$3(val));
    }
...
function convertComposerOptions(options) {
    ...
    const fallbackLocale = isString$2(options.fallbackLocale) ||
        ...
        ? options.fallbackLocale
        : locale;
    const missing = isFunction$2(options.missing) ? options.missing : undefined;
    ...
    if (options.formatter) {
        warn$2(getWarnMessage(I18nWarnCodes.NOT_SUPPORTED_FORMATTER));
    }
    if (options.preserveDirectiveContent) {
        warn$2(getWarnMessage(I18nWarnCodes.NOT_SUPPORTED_PRESERVE_DIRECTIVE));
    }
...
function createVueI18n(options = {}, VueI18nLegacy) {
    {
        ...
        const vueI18n = {
            ...
            getChoiceIndex(choice, choicesLength) {
                warn$2(getWarnMessage(I18nWarnCodes.NOT_SUPPORTED_GET_CHOICE_INDEX));
                return -1;
            },
            // for internal
...
keys) {
    if (keys.length === 1 && keys[0] === 'default') {
        ...
        return ret.reduce((slot, current) => {
            return (slot = [
                ...slot,
                ...(isArray$3(current.children) ? current.children : [current])
            ]);
        }, []);
    }
    else {
...
const Translation =  /* defineComponent */ {
    ...
    setup(props, context) {
        ...
        return () => {
            ...
            const tag = isString$2(props.tag) || isObject$2(props.tag)
                ? props.tag
                : getFragmentableTag();
...
function vTDirective(i18n) {
    const _process = (binding) => {
        ...
        if (modifiers.preserve) {
            warn$2(getWarnMessage(I18nWarnCodes.NOT_SUPPORTED_PRESERVE));
        }
...
function apply(app, i18n, ...options) {
    ...
    if (globalInstall && useI18nComponentName) {
        warn$2(getWarnMessage(I18nWarnCodes.COMPONENT_NAME_LEGACY_COMPATIBLE, {
    ...
    if (composer) {
        ...
        if (field === 'locale' && isString$2(payload.state.value)) {
            ...
            (isString$2(payload.state.value) ||
                isArray$3(payload.state.value) ||
                isObject$2(payload.state.value))) {
...
function useI18n(options = {}) {
    ...
    if (scope === 'parent') {
        ...
        if (composer == null) {
            {
                warn$2(getWarnMessage(I18nWarnCodes.NOT_FOUND_PARENT_SCOPE));
            }
            composer = global;
        }
        return composer;
...
function useI18nForLegacy(instance, scope, root, options = {} // eslint-disable-line @typescript-eslint/no-explicit-any
    ...
    // postTranslation handler
    const _postTranslation = isFunction$2(options.postTranslation)
        ? options.postTranslation
        : null;
    // prettier-ignore
...
var menu$2 = {
  ...
  simpleProductionPicking: 'production picking',
  simpleProductionPickingList: 'production picking list',
  simpleProductionReceipt: 'production receipt',
  simpleProductionReceiptList: 'production receipt list',
  simpleRroductionReturns: 'rroduction returns',
  simpleRroductionReturnsList: 'rroduction returns list',
...
var menu$1 = {
  ...
  purchaseList: '采购入库列表',
  purchaseReturn: '采购退料单',
  purchaseReturnList: '采购退料列表',
  ProductionManagement: '生产管理',
  simpleProductionPicking: '简单生产领料单',
  simpleProductionPickingList: '简单生产领料列表',
  simpleProductionReceipt: '简单生产入库单',
  simpleProductionReceiptList: '简单生产入库列表',
  simpleRroductionReturns: '简单生产退料单',
  simpleRroductionReturnsList: '简单生产退料列表',
...
var i18n = createI18n({
  ...
  messages: {
    'zh-cn': getMessage({ "./locales/zh-cn/error.js": __glob_1_0$1, "./locales/zh-cn/login.js": __glob_1_1$1, "./locales/zh-cn/menu.js": __glob_1_2$1, "./locales/zh-cn/public.js": __glob_1_3, "./locales/zh-cn/tags.js": __glob_1_4, "./locales/zh-cn/topbar.js": __glob_1_5, "./locales/zh-cn/test/list.js": __glob_1_6,}),
...
function createRouterError(type, params) {
    ...
    {
        return assign$1(new Error(ErrorTypeMessages[type](params)), {
            type,
...
const Layout$3 = () => __vitePreload(() => import('./index.695984bf.js'),true?["assets/index.695984bf.js","assets/index.b2d82588.css","assets/element-plus.2c54c765.js","assets/index.cb2fdb26.js","assets/index.0b906bcb.css","assets/ChangeLang.bd1aeaca.js","assets/ChangeLang.f191827b.css","assets/mockjs.5bb7b8f9.js"]:void 0);
const Redirect = () => __vitePreload(() => import('./index.516630b1.js'),true?["assets/index.516630b1.js","assets/element-plus.2c54c765.js","assets/mockjs.5bb7b8f9.js"]:void 0);
...
const Layout$2 = () => __vitePreload(() => import('./index.695984bf.js'),true?["assets/index.695984bf.js","assets/index.b2d82588.css","assets/element-plus.2c54c765.js","assets/index.cb2fdb26.js","assets/index.0b906bcb.css","assets/ChangeLang.bd1aeaca.js","assets/ChangeLang.f191827b.css","assets/mockjs.5bb7b8f9.js"]:void 0);
const Error$1 = () => __vitePreload(() => import('./index.a62ef5de.js'),true?["assets/index.a62ef5de.js","assets/index.162ce70f.css","assets/element-plus.2c54c765.js","assets/mockjs.5bb7b8f9.js"]:void 0);
...
const Login = () => __vitePreload(() => import('./index.09c1ff55.js'),true?["assets/index.09c1ff55.js","assets/index.37e2878d.css","assets/element-plus.2c54c765.js","assets/ChangeLang.bd1aeaca.js","assets/ChangeLang.f191827b.css","assets/vue3-puzzle-vcode.es.2134bfe3.js","assets/vue3-puzzle-vcode.es.1c806041.css","assets/mockjs.5bb7b8f9.js"]:void 0);
...
const Lock = () => __vitePreload(() => import('./index.3d7b3079.js'),true?["assets/index.3d7b3079.js","assets/index.7696a750.css","assets/element-plus.2c54c765.js","assets/index.cb2fdb26.js","assets/index.0b906bcb.css","assets/mockjs.5bb7b8f9.js"]:void 0);
...
// home.js
const Layout$1 = () => __vitePreload(() => import('./index.695984bf.js'),true?["assets/index.695984bf.js","assets/index.b2d82588.css","assets/element-plus.2c54c765.js","assets/index.cb2fdb26.js","assets/index.0b906bcb.css","assets/ChangeLang.bd1aeaca.js","assets/ChangeLang.f191827b.css","assets/mockjs.5bb7b8f9.js"]:void 0);
const Home = () => __vitePreload(() => import('./index.069e562a.js'),true?["assets/index.069e562a.js","assets/index.e36d6dc0.css","assets/element-plus.2c54c765.js","assets/mockjs.5bb7b8f9.js"]:void 0);
...
const Layout = () => __vitePreload(() => import('./index.695984bf.js'),true?["assets/index.695984bf.js","assets/index.b2d82588.css","assets/element-plus.2c54c765.js","assets/index.cb2fdb26.js","assets/index.0b906bcb.css","assets/ChangeLang.bd1aeaca.js","assets/ChangeLang.f191827b.css","assets/mockjs.5bb7b8f9.js"]:void 0);
const List = () => __vitePreload(() => import('./index.52c5cd44.js'),true?["assets/index.52c5cd44.js","assets/element-plus.2c54c765.js","assets/mockjs.5bb7b8f9.js"]:void 0);
const Add = () => __vitePreload(() => import('./Add.5025e6cc.js'),true?["assets/Add.5025e6cc.js","assets/element-plus.2c54c765.js","assets/mockjs.5bb7b8f9.js"]:void 0);
const Edit = () => __vitePreload(() => import('./Edit.12a7c893.js'),true?["assets/Edit.12a7c893.js","assets/element-plus.2c54c765.js","assets/mockjs.5bb7b8f9.js"]:void 0);
const Nest = () => __vitePreload(() => import('./Nest.4aa8bd63.js'),true?["assets/Nest.4aa8bd63.js","assets/element-plus.2c54c765.js","assets/mockjs.5bb7b8f9.js"]:void 0);

const PurchaseReceipt = () =>
  __vitePreload(() => import('./PurchaseReceipt.4a5307c3.js'),true?["assets/PurchaseReceipt.4a5307c3.js","assets/element-plus.2c54c765.js","assets/test.990c896f.js","assets/mockjs.5bb7b8f9.js"]:void 0);
const PurchaseReceiptList = () =>
  __vitePreload(() => import('./PurchaseReceiptList.e87dedf4.js'),true?["assets/PurchaseReceiptList.e87dedf4.js","assets/element-plus.2c54c765.js","assets/test.990c896f.js","assets/mockjs.5bb7b8f9.js"]:void 0);
const PurchaseReturn = () =>
  __vitePreload(() => import('./PurchaseReturn.a5d119ac.js'),true?["assets/PurchaseReturn.a5d119ac.js","assets/element-plus.2c54c765.js","assets/mockjs.5bb7b8f9.js"]:void 0);
const PurchaseReturnList = () =>
  __vitePreload(() => import('./PurchaseReturnList.a1b830f5.js'),true?["assets/PurchaseReturnList.a1b830f5.js","assets/element-plus.2c54c765.js","assets/mockjs.5bb7b8f9.js"]:void 0);

const simpleProductionPicking = () =>
  __vitePreload(() => import('./simpleProductionPicking.da6d900e.js'),true?["assets/simpleProductionPicking.da6d900e.js","assets/element-plus.2c54c765.js","assets/mockjs.5bb7b8f9.js"]:void 0);
const simpleProductionPickingList = () =>
  __vitePreload(() => import('./simpleProductionPickingList.75679baf.js'),true?["assets/simpleProductionPickingList.75679baf.js","assets/element-plus.2c54c765.js","assets/mockjs.5bb7b8f9.js"]:void 0);
const simpleProductionReceipt = () =>
  __vitePreload(() => import('./simpleProductionReceipt.a2fb8694.js'),true?["assets/simpleProductionReceipt.a2fb8694.js","assets/simpleProductionReceipt.fd5857a7.css","assets/element-plus.2c54c765.js","assets/mockjs.5bb7b8f9.js"]:void 0);
const simpleProductionReceiptList = () =>
  __vitePreload(() => import('./simpleProductionReceiptList.88589c44.js'),true?["assets/simpleProductionReceiptList.88589c44.js","assets/element-plus.2c54c765.js","assets/test.990c896f.js","assets/mockjs.5bb7b8f9.js"]:void 0);
const simpleRroductionReturns = () =>
  __vitePreload(() => import('./simpleRroductionReturns.675e3d0b.js'),true?["assets/simpleRroductionReturns.675e3d0b.js","assets/element-plus.2c54c765.js","assets/vue3-puzzle-vcode.es.2134bfe3.js","assets/vue3-puzzle-vcode.es.1c806041.css"]:void 0);
const simpleRroductionReturnsList = () =>
  __vitePreload(() => import('./simpleRroductionReturnsList.2967ef9d.js'),true?["assets/simpleRroductionReturnsList.2967ef9d.js","assets/element-plus.2c54c765.js"]:void 0);

const Iscache = () => __vitePreload(() => import('./Cache.837b7067.js'),true?["assets/Cache.837b7067.js","assets/element-plus.2c54c765.js","assets/mockjs.5bb7b8f9.js"]:void 0);
const Nocache = () => __vitePreload(() => import('./Nocache.4f683482.js'),true?["assets/Nocache.4f683482.js","assets/element-plus.2c54c765.js","assets/mockjs.5bb7b8f9.js"]:void 0);
const ErrorLog = () => __vitePreload(() => import('./index.22400ac6.js'),true?["assets/index.22400ac6.js","assets/index.c1ae576f.css","assets/element-plus.2c54c765.js","assets/test.990c896f.js","assets/mockjs.5bb7b8f9.js"]:void 0);
...
var test$1 = [
  {
    ...
    children: [
...

      {
        ...
        component: Nest,
        meta: {
          title: 'menu.ProductionManagement',
        },
        children: [
          {
            path: 'simpleProductionPicking',
            name: 'simpleProductionPicking',
            component: simpleProductionPicking,
            meta: {
              title: 'menu.simpleProductionPicking',
            },
          },
          {
            path: 'simpleProductionPickingList',
            name: 'simpleProductionPickingList',
            component: simpleProductionPickingList,
            meta: {
              title: 'menu.simpleProductionPickingList',
            },
          },
          {
            path: 'simpleProductionReceipt',
            name: 'simpleProductionReceipt',
            component: simpleProductionReceipt,
            meta: {
              title: 'menu.simpleProductionReceipt',
            },
          },
          {
            path: 'simpleProductionReceiptList',
            name: 'simpleProductionReceiptList',
            component: simpleProductionReceiptList,
            meta: {
              title: 'menu.simpleProductionReceiptList',
            },
          },
          {
            path: 'simpleRroductionReturns',
            name: 'simpleRroductionReturns',
            component: simpleRroductionReturns,
            meta: {
              title: 'menu.simpleRroductionReturns',
            },
          },
          {
            path: 'simpleRroductionReturnsList',
            name: 'simpleRroductionReturnsList',
            component: simpleRroductionReturnsList,
            meta: {
              title: 'menu.simpleRroductionReturnsList',
            },
          },
        ],
      },
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createElementBlock("svg", _hoisted_1$1, [
    createBaseVNode("use", { "xlink:href": _ctx.symbolId }, null, 8 /* PROPS */, _hoisted_2$1)
  ]))
}
var index$1 = /*#__PURE__*/_export_sfc(_sfc_main$1, [['render',_sfc_render$1],['__scopeId',"data-v-c8a70580"]]);
  ...
  return (openBlock(), createElementBlock("div", _hoisted_1, [
    ...
    (!!_ctx.search)
      ? (openBlock(), createBlock(_component_el_form, {
                  ...
                  (item.type === 'custom')
                    ...
                    : (item.type === 'select')
                      ? (openBlock(), createBlock(_component_el_select, {
                          ...
                          _: 2 /* DYNAMIC */
                        }, 1032 /* PROPS, DYNAMIC_SLOTS */, ["modelValue", "onUpdate:modelValue", "filterable", "multiple", "placeholder", "style"]))
                      : (item.type === 'radio')
                        ? (openBlock(), createBlock(_component_el_radio_group, {
                            ...
                            default: withCtx(() => [
                              (openBlock(true), createElementBlock(Fragment, null, renderList(item.options, (option) => {
                                return (openBlock(), createBlock(_component_el_radio, {
                                  ...
                                  default: withCtx(() => [
                                    createTextVNode(toDisplayString$1(_ctx.$t(option.name)), 1 /* TEXT */)
                                  ]),
                                  _: 2 /* DYNAMIC */
                            ...
                            _: 2 /* DYNAMIC */
                          }, 1032 /* PROPS, DYNAMIC_SLOTS */, ["modelValue", "onUpdate:modelValue", "style"]))
                            ...
                            : (item.type === 'checkbox-button')
                              ...
                              : (item.type === 'date')
                                ? (openBlock(), createBlock(_component_el_date_picker, {
                                    ...
                                    placeholder: _ctx.$t(item.label),
                                    style: normalizeStyle({ width: _ctx.search.inputWidth, ...item.style })
                                  }, null, 8 /* PROPS */, ["modelValue", "onUpdate:modelValue", "onChange", "placeholder", "style"]))
                                : (item.type === 'datetime')
                                  ? (openBlock(), createBlock(_component_el_date_picker, {
                                      key: 7,
                                      modelValue: _ctx.searchModel[item.name],
                                  ...
                                  : (item.type === 'daterange')
                                    ? (openBlock(), createBlock(_component_el_date_picker, {
                                      ...
                                      }, null, 8 /* PROPS */, ["modelValue", "onUpdate:modelValue", "start-placeholder", "end-placeholder", "onChange", "style"]))
                                    : (item.type === 'datetimerange')
                                      ...
                                      : (item.type === 'number')
                                        ? (openBlock(), createBlock(_component_el_input_number, {
                                            ...
                                            max: item.max,
                                            style: normalizeStyle({ width: _ctx.search.inputWidth, ...item.style })
                                          }, null, 8 /* PROPS */, ["modelValue", "onUpdate:modelValue", "placeholder", "min", "max", "style"]))
                                        : (item.type === 'textarea')
                                          ? (openBlock(), createBlock(_component_el_input, {
                                              ...
                                              placeholder: _ctx.$t(item.label),
                                              style: normalizeStyle({ width: _ctx.search.inputWidth, ...item.style })
                                            }, null, 8 /* PROPS */, ["maxlength", "modelValue", "onUpdate:modelValue", "placeholder", "style"]))
                                          : (openBlock(), createBlock(_component_el_input, {
                                              key: 12,
                                              maxlength: item.maxlength,
                                              modelValue: _ctx.searchModel[item.name],
            ...
            createVNode(_component_el_form_item, { class: "search-btn" }, {
              default: withCtx(() => [
                createVNode(_component_el_button, {
                  ...
                  default: withCtx(() => [
                    createTextVNode(toDisplayString$1(_ctx.$t('public.search')), 1 /* TEXT */)
                  ]),
                  _: 1 /* STABLE */
                }, 8 /* PROPS */, ["onClick"]),
                createVNode(_component_el_button, {
                  ...
                  default: withCtx(() => [
                    createTextVNode(toDisplayString$1(_ctx.$t('public.reset')), 1 /* TEXT */)
                  ]),
                  _: 1 /* STABLE */
                }, 8 /* PROPS */, ["onClick"])
              ]),
          ...
          _: 3 /* FORWARDED */
        }, 8 /* PROPS */, ["model", "label-width"]))
      : createCommentVNode("v-if", true),
    createCommentVNode(" title 和 工具栏 "),
    (!_ctx.hideTitleBar)
      ? (openBlock(), createElementBlock("div", _hoisted_2, [
          renderSlot(_ctx.$slots, "title", {}, () => [
            createBaseVNode("span", _hoisted_3, toDisplayString$1(_ctx.title), 1 /* TEXT */)
          ], true),
          ...
          (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.columns, (item) => {
            return (openBlock(), createBlock(_component_el_table_column, mergeProps({
              ...
              (!!item.tdSlot)
                ...
                : undefined
            ]), 1040 /* FULL_PROPS, DYNAMIC_SLOTS */, ["filter-method", "show-overflow-tooltip", "label"]))
          }), 128 /* KEYED_FRAGMENT */))
        ]),
        _: 3 /* FORWARDED */
      }, 8 /* PROPS */, ["data", "row-key", "border", "onSelectionChange"])), [
    ...
    (_ctx.paginationConfig.show && _ctx.total > 0)
      ? (openBlock(), createBlock(_component_el_pagination, {
          ...
          total: _ctx.total
        }, null, 8 /* PROPS */, ["style", "onSizeChange", "currentPage", "onCurrentChange", "page-sizes", "pageSize", "layout", "total"]))
      : createCommentVNode("v-if", true)
  ]))
}
var index = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render],['__scopeId',"data-v-2a6bca94"]]);
  ...
  },
  {
    ...
    response: {
      ...
      data: {
        ...
        avatar:
          'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fc-ssl.duitang.com%2Fuploads%2Fblog%2F202105%2F09%2F20210509012315_89541.thumb.1000_0.jpeg&refer=http%3A%2F%2Fc-ssl.duitang.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=auto?sec=1680677874&t=d8d86c741fe8917eab46271c0e720cc9',
      },
    },
  },
];
...
// 生产当月的开始日期
const startDate = new Date('2022-10-08 00:00:00');
// 截止日期
const endDate = new Date('2023-03-10 17:00:00');
var test = [
  {
    url: '/api/get', // 请求地址
    method: 'get', // 请求方法
  ...
  // 请求用户列表
  {
    ...
    response: ({ body }) => {
      ...
      for (let index = 0; index < size; index++) {
        const a = {
          'id|+1': 1,
          No: cnunt() + 20230000 + index,
          time: hooks(randomDate(startDate, endDate)).format(
            'YYYY-MM-DD HH:mm:ss'
          ),
          'status|1': [0, 1],
          encoded: 8512351820546 + Math.floor(Math.random() * 1000 + 1),
          productName: '@cword(7,15)',
          unit: '件',
          number: '@integer(1,20000)',
          'workshop|1': ['冲压车间', '焊装车间'],
          storehouse: '成品库',
          // encoded:
          'children|1-3': [
            {
              ...
              time: '',
              status: [],
              encoded: 8512351820158 + Math.floor(Math.random() * 1000 + 1),
              productName: '@cword(7,15)',
              unit: '件',
              number: '@integer(1,20000)',
              'workshop|1': ['冲压车间', '焊装车间'],
...
const modules = { "./login.js": __glob_1_0, "./menu.js": __glob_1_1, "./test.js": __glob_1_2,};
...
export { AesEncryption as A, Login$1 as L, _export_sfc as _, useRoute as a, useMenus as b, useApp as c, defineStore as d, setItem as e, useErrorlog as f, getItem as g, useTags as h, useLang as i, useAccount as j, service as k, storeToRefs as s, useRouter as u };
