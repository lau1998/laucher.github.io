import { c as commonjsGlobal, ad as cloneDeep, l as defineComponent, t as reactive, r as ref, I as toRefs, m as resolveComponent, n as openBlock, p as createBlock, q as withCtx, k as createVNode, V as createTextVNode, W as toDisplayString } from './element-plus.2c54c765.js';
import { g as getUsers } from './test.990c896f.js';
...
function blobify(data) {
	if(typeof data === "string") return s2ab$1(data);
...
function write_dl(fname/*:string*/, payload/*:any*/, enc/*:?string*/) {
	if(typeof Deno !== 'undefined') {
		...
		if(enc && typeof payload == "string") switch(enc) {
			...
			case "binary": payload = s2ab$1(payload); break;
...
function writeSync(wb/*:Workbook*/, opts/*:?WriteOpts*/) {
	...
	if(o.type == "array") { o.type = "binary"; var out/*:string*/ = (writeSync(wb, o)/*:any*/); o.type = "array"; return s2ab$1(out); }
	var idx = 0;
	if(o.sheet) {
...
// 使用数据导出excel
const excelExport2 = (data, headers, filename) => {
  ...
  const ws = utils.json_to_sheet(json, { header: Object.values(headers) });
  ...
  const wbout = writeSync(wb, wopts);
  const blob = new Blob([s2ab(wbout)], { type: 'application/octet-stream' });
  fs.saveAs(blob, filename + '.xlsx');
};

console.log(excelExport2);
  ...
  setup() {
    ...
    const state = reactive({
      ...
      columns: [
        ...
        { label: '单据编号', type: 'No', width: 100, prop: 'No' },
        {
          label: '日期',
          prop: 'time',
          sortable: true,
    ...
    //导出excel
    const bindExcelExport = () => {
      // console.log('table', table.value.tableData)
      excelExport2(
    ...
    return { ...toRefs(state), refresh, table, bindExcelExport }
  },
});
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock(_component_pro_table, {
    ...
    pagination: _ctx.paginationConfig,
    ...
    toolbar: withCtx(() => [
      createVNode(_component_el_button, {
        ...
        onClick: _ctx.bindExcelExport
      }, {
        default: withCtx(() => [
          createTextVNode(" Excel " + toDisplayString(_ctx.$t('test/list.leadingOut')), 1 /* TEXT */)
        ]),
        _: 1 /* STABLE */
      }, 8 /* PROPS */, ["onClick"]),
      createVNode(_component_el_button, {
        ...
        default: withCtx(() => [
          createTextVNode(toDisplayString(_ctx.$t('test/list.refresh')), 1 /* TEXT */)
        ]),
        _: 1 /* STABLE */
      }, 8 /* PROPS */, ["onClick"])
    ]),
    status: withCtx(({row}) => [
      createVNode(_component_el_tag, {
        ...
        default: withCtx(() => [
          createTextVNode(toDisplayString(row.status === 1 ? '已审核' : '未审核'), 1 /* TEXT */)
        ]),
        _: 2 /* DYNAMIC */
    ...
    operate: withCtx((scope) => [
      createVNode(_component_el_button, {
        ...
        default: withCtx(() => [
          createTextVNode(toDisplayString(_ctx.$t('public.edit')), 1 /* TEXT */)
        ]),
        _: 2 /* DYNAMIC */
      ...
      createVNode(_component_el_button, {
        ...
        default: withCtx(() => [
          createTextVNode(toDisplayString(_ctx.$t('public.delete')), 1 /* TEXT */)
        ]),
        _: 1 /* STABLE */
      })
    ]),
    ...
    _: 1 /* STABLE */
  }, 8 /* PROPS */, ["title", "request", "columns", "search", "pagination", "onSelectionChange"]))
}
var simpleProductionReceiptList = /*#__PURE__*/_export_sfc(_sfc_main, [['render',_sfc_render]]);

export { simpleProductionReceiptList as default };
